package com.semisky.autotesttool.service;
...
public class LogcatService extends Service {
    ...
    private void killLogcatProc(List<ProcessInfo> allProcList) {
        ...
        for (ProcessInfo processInfo : allProcList) {
            if (processInfo.name.toLowerCase(Locale.getDefault()).equals(
                    "logcat")
    ...
    private void deployLogTask() {
        Intent intent = new Intent(ACTION_START_NEW_DAY_LOG);
